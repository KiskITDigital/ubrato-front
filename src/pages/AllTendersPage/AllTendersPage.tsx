    ...
    <div ref={startRef} className={s.main_blokkk}>
      ...
      <div className="w-[1130px] mx-auto text-[20px]">
        ...
        <p className="text-[#666] mb-5">
          Комфортный поиск выгодных тендеров на оказание клининговых и сопутствующих услуг в городе
          Москва на одной онлайн-площадке — это реальность. Сервис Ubrato предоставляет доступ к
          объявлениям без посредников.
        </p>
        <p className="text-[#666] mb-5">
          Здесь вы найдете актуальную информацию о подрядах и требующихся услугах клининга для жилых
          и нежилых объектов недвижимости в городе Москва, в том числе для промышленных,
          транспортных площадок, парковых, заповедных зон, торговых центров, домов и квартир. Ubrato
          предлагает принципиально новый комфортный формат поиска тендеров и получения заказов.
        </p>
        <p className="text-[#666] mb-5">
        ...
        <p className="text-[#666]">
          ...
          сервисом Ubrato комфортно работать, потому что для его пользователей предусмотрено все: от
          интуитивного интерфейса, удобной навигации по сайту до системы точных, понятных фильтров и
          сортировки опций клининга. На карточках тендеров выводится систематизированная информация,
          потому сориентироваться в заявках заказчиков вам не составит труда.
        </p>
      </div>
    </div>
  );
