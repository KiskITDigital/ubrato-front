    ...
    <section>
      ...
      <div className="w-[1130px] mx-auto text-[20px]">
        <h2 className="text-[46px] font-black text-center mb-5">
          Поручите клининг Ваших объектов профессионалам
        </h2>
        <div className={`${styles.content} ${isCollapsed ? "h-[150px]" : "h-fit"}`}>
          ...
          <p className="text-[#666] mb-5">
            ...
            проблема для владельцев, арендаторов объектов жилой и нежилой недвижимости,
            рекреационных, промышленных, транспортных площадок, руководителей предприятий всех форм
            собственности, организаторов массовых мероприятий и торжеств. Ubrato предлагает ее
            реальное решение.
          </p>
          <p className="text-[#666] mb-5">
          ...
          <p className="text-[#666]">
            ...
            клининг и выбирают подходящие для определенных объектов пакеты клининговых и
            сопутствующих услуг. Интуитивно понятный интерфейс, удобная навигация сайта делают
            процесс выбора подрядчиков простым, комфортным, результативным.
          </p>
