...
interface createTenderState {
    ...
    handleSimpleInput: (whatToChange: 'name' | 'reception_time_start' | 'reception_time_end' | 'price' | 'is_contract_price' | 'is_NDS' | 'description' | 'wishes' | 'floor_space' | 'objectName' | 'objectCategory', newVal: string | boolean, mask?: (value: string) => string) => void
...
export const useCreateTenderState = create<createTenderState>()((set) => ({
    ...
    "object_group_id": 0,
    "object_type_id": 0,
    handleSimpleInput: (whatToChange: 'name' | 'reception_time_start' | 'reception_time_end' | 'price' | 'is_contract_price' | 'is_NDS' | 'description' | 'wishes' | 'floor_space' | 'objectName' | 'objectCategory', newVal: string | boolean, mask?: (value: string) => string) => {
