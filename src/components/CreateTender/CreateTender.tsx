...
export const CreateTender: FC = () => {
  ...
  const [chooseTypesTypesToObjectToAddObject, setChooseTypesTypesToObjectToAddObject] = useState<
    string[]
  >([]);

  const [isChoosingServiceToAdd, setIsChoosingServiceToAdd] = useState(false);
  const [chooseTypesNameToObjectToAddService, setChooseTypesNameToObjectToAddService] = useState<
    null | string
  >(null);
  const [chooseTypesTypesToObjectToAddService, setChooseTypesTypesToObjectToAddService] = useState<
    string[]
  >([]);

  const [isChoosingServiceToChange, setIsChoosingServiceToChange] = useState<null | number>(null);
  const [chooseTypesNameToObjectToChangeService, setChooseTypesNameToObjectToChangeService] =
    useState<null | string>(null);
  const [chooseTypesTypesToObjectToChangeService, setChooseTypesTypesToObjectToChangeService] =
    useState<string[]>([]);
  ...
  return (
    <div className={`container ${styles.container}`}>
      <div className={`${styles.title}`}>
        ...
        <p className={`${styles.title__p} ${styles.textBlack60} ${styles.textRegular}`}>
          Статус:{' '}
          <span className={`${styles.textBlack} ${styles.textMedium}`}>{'Создание тендера'}</span>
        </p>
      </div>
      <div className={`${styles.nameTender}`}>
        ...
        <input
          ...
          className={`${styles.nameTender__input} ${styles.input} ${
            createTenderState.errors.includes('name') ? styles.inputError : ''
          }`}
      ...
      <div className={`${styles.switcher}`}>
        <div
          onClick={() => setSwitcher('Тендер')}
          className={`${styles.switcher__div} ${
            switcher === 'Тендер' ? `${styles.borderBottomBlue}` : ''
          }`}
        >
          <p
            className={`${styles.switcher__p} ${
              switcher === 'Тендер'
                ? `${styles.textMedium} ${styles.textBlack}`
                : `${styles.textReguar} ${styles.textBlack60}`
            }`}
          >
            Тендер
          </p>
        ...
        {status !== 'создание тендера' && (
          <>
            <div className={`${styles.switcher__div}`}>
              <span className={`${styles.switcher__span}`}></span>
            </div>
            <div
              onClick={() => setSwitcher('Отклики')}
              className={`${styles.switcher__div} ${
                switcher === 'Отклики' ? `${styles.borderBottomBlue}` : ''
              }`}
            >
              <p
                className={`${styles.switcher__p} ${
              ...
              <p className={`${styles.switcher__p2}`}>{2}</p>
            </div>
            <div className={`${styles.switcher__div}`}>
              <span className={`${styles.switcher__span}`}></span>
            </div>
            <div
              onClick={() => setSwitcher('Чат')}
              className={`${styles.switcher__div} ${
                switcher === 'Чат' ? `${styles.borderBottomBlue}` : ''
              }`}
            >
              <p
                className={`${styles.switcher__p} ${
              ...
              <p className={`${styles.switcher__p2}`}>{34}</p>
            </div>
            <div className={`${styles.switcher__div}`}>
              <span className={`${styles.switcher__span}`}></span>
            </div>
            <div
              onClick={() => setSwitcher('Доп. информация')}
              className={`${styles.switcher__div} ${
                switcher === 'Доп. информация' ? `${styles.borderBottomBlue}` : ''
              }`}
            >
              <p
                className={`${styles.switcher__p} ${
                  switcher === 'Доп. информация'
                    ? `${styles.textMedium} ${styles.textBlack}`
                    : `${styles.textReguar} ${styles.textBlack60}`
                }`}
              >
        ...
        {windowWidth > 1050 && (
          <div className={`${styles.switcher__div} ${styles.switcher__lastdiv}`}>
            <img src="/create-tender/refresh.svg" alt="refresh" />
        ...
        <>
          <div className={`${styles.firstSections}`}>
                ...
                <div className={`${styles.firstSections__div__main__block}`}>
                  ...
                  <div className={styles.firstSections__responses__inputs}>
                    ...
                    <DatePicker
                      ...
                      onChange={(date) =>
                        createTenderState.handleSimpleInput('reception_start', date!)
                      }
                      selectsStart
                ...
                <div className={`${styles.firstSections__div__main__block}`}>
                  ...
                  <div className={styles.firstSections__responses__inputs}>
                    <DatePicker
                      ...
                      onChange={(date) =>
                        createTenderState.handleSimpleInput('reception_end', date!)
                      }
                      selectsEnd
                      dateFormat="dd.MM.yyyy"
                      startDate={createTenderState.reception_start}
            ...
            <div className={`${styles.firstSections__div}`}>
              ...
              <div className={`${styles.firstSections__div__main}`}>
                <div className={`${styles.firstSections__div__main__block}`}>
                  <p className={`${styles.firstSections__div__main__block__p}`}>
                    Стоимость в рублях
                  </p>
                  <input
                    ...
                    className={`${styles.input} ${styles.firstSections__div__main__block__input} ${
                      createTenderState.errors.includes('price') ? styles.inputError : ''
                    }`}
                    type="text"
                  />
                  {createTenderState.errors.includes('price') && (
                    <p
          ...
          <div className={`${styles.section} ${styles.cleaningTZ}`}>
            <div className={`${styles.section__block}`}>
              <p
                className={`${styles.section__block__p} ${styles.textReguar} ${styles.textBlack50}`}
              >
                ТЗ на уборку:
              </p>
              <button className={`${styles.section__block__button} ${styles.textRegular}`}>
              ...
              <div className={`${styles.services__block} ${styles.services__cities}`}>
                {isCitiesAutoComplete || !createTenderState.city ? (
                  <>
                    <input
                      onFocus={() => {
                        createTenderState.removeError('city');
                        setIsCitiesAutoComplete(true);
                      }}
                      onBlur={() => {
                        ...
                        if (createTenderState.cities.length) {
                          createTenderState.handleSimpleInput(
                            'city',
                            createTenderState.cities[0].name
                          );
                        } else {
                      ...
                      onChange={(e) => {
                        createTenderState.handleSimpleInput('city', e.currentTarget.value);
                        createTenderState.getCities(e.currentTarget.value);
                      }}
                      type="text"
                      className={`${styles.input} ${styles.cities__input} ${
                        createTenderState.errors.includes('city') ? styles.inputError : ''
                      }`}
                    />
                    {createTenderState.errors.includes('city') && (
                      <p
                        className={`${styles.inputErrorText} ${styles.inputErrorTextFloorSspace} ${styles.inputErrorTextCity}`}
                      >
                        Обязательно для заполнения
                      </p>
                    )}
                    {isCitiesAutoComplete &&
                      !!createTenderState.city.length &&
                      !!createTenderState.cities.length && (
                        <div className={styles.cities__autocomplete}>
                  ...
                  <p
                    className={`${styles.services__block__service__type} ${styles.section__block__add__object__objectCategory} ${styles.city__autocomplete__chosen}`}
                  >
                    {createTenderState.city}
                    <span
                      className={`${styles.section__block__add__object__objectCategory__span}`}
                    ></span>
                    <img
                      onClick={() => createTenderState.handleSimpleInput('city', '')}
                      className={`${styles.section__block__add__object__objectCategory__img}`}
                      src={closeWhiteImg}
                      alt=""
                    />
                  </p>
          ...
          <div className={`${styles.section} ${styles.object}`}>
            <div className={`${styles.section__block}`}>
              ...
              {windowWidth <= 1050 ? (
                    ...
                    >
                      {
                        ...
                        objectsStore.apiObjects
                          ?.find((el) => el.name === createTenderState.objectName)
                          ?.types.map((type) => (
                            <Checkbox
                          ...
                          <p
                            onClick={() => {
                              ...
                              setChoosingObjectTypes(
                                object.types.map((object) => ({ ...object, count: 0 }))
                              );
                            }}
                            className={styles.cities__autocomplete__item}
                            key={object.id}
                ...
                <div className={`${styles.section__block__add__object}`}>
                  {!!createTenderState.objectCategory.length && (
                    <div
                      className={`${styles.services__block__service} ${styles.object__block__service}`}
                    >
                      ...
                      <div className={`${styles.services__block__service__types}`}>
                        {createTenderState.objectCategory.map((type, ind) => (
                          <p
                            key={ind}
                            className={`${styles.services__block__service__type} ${styles.section__block__add__object__objectCategory}`}
                          >
                            {type}
                            <span
                              className={`${styles.section__block__add__object__objectCategory__span}`}
                            ...
                            <img
                              onClick={() => {
                                ...
                                setChooseTypesTypesToObjectToAddObject((prev) =>
                  ...
                  {objectsStore.apiObjects.map(
                    (object: {
                      ...
                      <p
                        ...
                        onClick={() => {
                          setChoosingObjectTypes(
                            object.types.map((el) => ({ id: el.id, name: el.name, count: 0 }))
                          );
                      ...
                      >
                        {object.name}{' '}
                        {object.name === isObjectChoosed && <img src={arrowRightImg} alt="" />}
                      </p>
                    )
                  )}
                </div>
                    ...
                    {isObjectChoosed && (
                      <>
                        ...
                        <button
                          ...
                          className={styles.object__objects__types__button}
                          disabled={!chooseTypesTypesToObjectToAddObject.length}
                        >
                          Применить
                        </button>
                      </>
            ...
            <div className={`${styles.section__block} ${styles.square}`}>
              ...
              <input
                ...
                onBlur={() =>
                  !createTenderState.floor_space && createTenderState.addError('floor_space')
                }
              ...
              />
              <label
                className={`${styles.square__label} ${styles.textReguar} ${styles.textBlack50}`}
                htmlFor=""
              >
                кв. м.
              </label>
          ...
          <div className={`${styles.section} ${styles.services}`}>
            ...
            {windowWidth <= 1050 ? (
              <>
                {createTenderState.services.map((service) => (
                  <Fragment key={service.id}>
                    <button
                      onClick={() => {
                        createTenderState.removeService(service.id);
                      }}
                      className={`${styles.section__block__button} ${styles.textRegular}`}
                    >
                      <img src={closeImg} alt="close" />
                    ...
                    >
                      {cleaningTypeStore.apiCleaningTypes
                        .find((ser) => ser.name === service.name)
                        ?.types.map((type) => (
                          <Checkbox
                            ...
                            className={`${styles.object__objects__types__p} ${
                              ...
                              service.types.some((el) => el.name === type.name)
                                ? `${styles.CheckboxNextUIActive} ${styles.CheckboxNextUIActiveTypes}`
                                : ''
                            }`}
                            key={type.id}
                ...
                <button
                  onClick={() => {
                    setIsChoosingNewServiceNameMobile((prev) => !prev);
                  }}
                  className={`${styles.section__block__button} ${styles.textRegular} ${
                    createTenderState.errors.includes('object')
                      ? styles.section__block__buttonError
                ...
                {createTenderState.errors.includes('services') && (
                  <p
                    className={`${styles.inputErrorText} ${styles.inputErrorTextFloorSspace} ${styles.servicesError}`}
                  >
                    Обязательно для заполнения
                  </p>
                )}
                {isChoosingNewServiceNameMobile && (
                  <div
                    // onBlur={() => setIsChoosingObjectNameMobile(false)}
                    className={`${styles.cities__autocomplete} ${styles.objectTypesSelectorMobile}`}
                  >
                    {cleaningTypeStore.apiCleaningTypes.map(
                      (service) =>
                        !createTenderState.services.some((el) => el.name === service.name) && (
                          <p
                            onClick={() => {
                              setIsChoosingNewServiceNameMobile(false);
                              createTenderState.addService(service.name, []);
                            }}
                            className={styles.cities__autocomplete__item}
                            key={service.id}
                          >
              ...
              <div className={`${styles.services__block}`}>
                {createTenderState.services.length > 0 && (
                  <div className={styles.services__block__services}>
                    {createTenderState.services.map((service) => (
                      <div className={styles.services__block__serviceToChange} key={service.id}>
                        <div key={service.id} className={`${styles.services__block__service}`}>
                          ...
                          <div className={`${styles.services__block__service__types}`}>
                            {service.types.map((type) => (
                              ...
                              >
                                ...
                                <img
                                  onClick={() =>
                                    createTenderState.removeServiceType(service.id, type.id)
                                  }
                                  className={`${styles.section__block__add__object__objectCategory__img}`}
                                  src={closeWhiteImg}
                                  alt=""
                          ...
                          <button
                            onClick={() => {
                              setIsChoosingServiceToChange(service.id);
                              setChooseTypesNameToObjectToChangeService(service.name);
                              setChooseTypesTypesToObjectToChangeService(
                                service.types.map((type) => type.name)
                              );
                            }}
                            className={`${styles.section__block__button} ${styles.service__button} ${styles.services__block__service__change}`}
                          >
                            Изменить
                          </button>
                          <button
                            onClick={() => createTenderState.removeService(service.id)}
                            className={`${styles.section__block__button} ${styles.service__button} ${styles.services__block__service__remove}`}
                          >
                            <img src={closeImg} alt="" />
                          </button>
                        </div>

                        {isChoosingServiceToChange === service.id && (
                          <div
                          ...
                          >
                            ...
                            >
                              {cleaningTypeStore.apiCleaningTypes.map(
                                (service) =>
                                  !createTenderState.services.some(
                                    (el) => el.name === service.name
                                  ) && (
                                    <p
                                      onClick={() => {
                                        setChooseTypesNameToObjectToChangeService(service.name);
                                      ...
                                      className={`${styles.object__objects__objects__p} ${
                                        service.name === chooseTypesNameToObjectToChangeService
                                          ? styles.object__objects__objects__pSelected
                                          : ''
                                      }`}
                                      key={service.id}
                                      ...
                                      ?.types.map((type) => (
                                        <Checkbox
                                          className={`${styles.object__objects__types__p} ${
                                            ...
                                            chooseTypesTypesToObjectToChangeService.includes(
                                              type.name
                                            )
                                              ? `${styles.CheckboxNextUIActive} ${styles.CheckboxNextUIActiveTypes}`
                                              : ''
                                  ...
                                  <button
                                    onClick={() => {
                                      if (chooseTypesTypesToObjectToChangeService.length) {
                                        ...
                                        createTenderState.changeService(
                                          isChoosingServiceToChange,
                                          chooseTypesNameToObjectToChangeService,
                                          chooseTypesTypesToObjectToChangeService
                                        );
                                        setChooseTypesTypesToObjectToChangeService([]);
                                    ...
                                    className={styles.object__objects__types__button}
                                    disabled={!chooseTypesTypesToObjectToChangeService.length}
                                  >
                                    Применить
                                  </button>
                                </>
                ...
                <button
                  onClick={() => {
                    setIsChoosingServiceToAdd((prev) => !prev);
                    setChooseTypesNameToObjectToAddService(null);
                  }}
                  className={`${styles.section__block__button} ${styles.service__button} ${
                    styles.textRegular
                  } ${
                    createTenderState.errors.includes('services')
                      ? styles.section__block__buttonError
                ...
                >
                  <img src={isChoosingServiceToAdd ? closeImg : plusImg} alt="plus" />
                  {isChoosingServiceToAdd ? 'Отмена' : 'Добавить услугу'}
                </button>
                {createTenderState.errors.includes('services') && (
                  <p
                    className={`${styles.inputErrorText} ${styles.inputErrorTextFloorSspace} ${styles.servicesError}`}
                ...
                {isChoosingServiceToAdd && (
                  <div
                    className={`${styles.object__types} ${styles.services__types} ${
                      chooseTypesNameToObjectToAddService
                        ? ''
                        : `${styles.object__typesHalf} ${styles.services__typesHalf}`
                    }`}
                    // className={`${styles.object__objects} ${styles.service__objects}`}
                  >
                    <div
                      ...
                      {cleaningTypeStore.apiCleaningTypes.map(
                        (service) =>
                          !createTenderState.services.some((el) => el.name === service.name) && (
                            <p
                              onClick={() => {
                                setChooseTypesNameToObjectToAddService(service.name);
                                setChooseTypesTypesToObjectToAddService([]);
                              }}
                              className={`${styles.object__objects__objects__p} ${
                                service.name === chooseTypesNameToObjectToAddService
                                  ? styles.object__objects__objects__pSelected
                                  : ''
                              }`}
                              key={service.id}
                        ...
                        {chooseTypesNameToObjectToAddService && (
                          <>
                            ...
                            >
                              {cleaningTypeStore.apiCleaningTypes
                                .find(
                                  (service) => service.name === chooseTypesNameToObjectToAddService
                                )
                                ?.types.map((type) => (
                                  <Checkbox
                                    className={`${styles.object__objects__types__p} ${
                                      ...
                                      chooseTypesTypesToObjectToAddService.includes(type.name)
                                        ? `${styles.CheckboxNextUIActive} ${styles.CheckboxNextUIActiveTypes}`
                                        : ''
                                    }`}
                                    key={type.id}
                            ...
                            <button
                              onClick={() => {
                                if (chooseTypesTypesToObjectToAddService.length) {
                                  createTenderState.addService(
                                    chooseTypesNameToObjectToAddService,
                                    chooseTypesTypesToObjectToAddService
                                  );
                                  setChooseTypesTypesToObjectToAddService([]);
                                  setChooseTypesNameToObjectToAddService(null);
                                  setIsChoosingServiceToAdd(false);
                              ...
                              className={styles.object__objects__types__button}
                              disabled={!chooseTypesTypesToObjectToAddService.length}
                            >
                              Применить
                            </button>
                          </>
          ...
          <div className={`${styles.section} ${styles.description}`}>
            <div className={`${styles.section__block}`}>
              ...
              <textarea
                ...
                onBlur={() =>
                  !createTenderState.description && createTenderState.addError('description')
                }
                value={createTenderState.description}
                onChange={(e) =>
                  createTenderState.handleSimpleInput('description', e.currentTarget.value)
                }
                name=""
                id=""
                rows={5}
                className={`${styles.input} ${styles.description__textarea} ${
                  createTenderState.errors.includes('description') ? styles.inputError : ''
                }`}
              ></textarea>
              {createTenderState.errors.includes('description') && (
                <p className={`${styles.inputErrorText} ${styles.textAreaError}`}>
                  Обязательно для заполнения
                </p>
              )}
            </div>
          ...
          <div className={`${styles.section} ${styles.wishes}`}>
            <div className={`${styles.section__block}`}>
              ...
              <textarea
                ...
                onChange={(e) =>
                  createTenderState.handleSimpleInput('wishes', e.currentTarget.value)
                }
                name=""
                id=""
                rows={5}
                className={`${styles.input} ${styles.wishes__textarea} ${
                  createTenderState.errors.includes('wishes') ? styles.inputError : ''
                }`}
              ></textarea>
              {createTenderState.errors.includes('wishes') && (
                <p className={`${styles.inputErrorText} ${styles.textAreaError}`}>
                  Обязательно для заполнения
                </p>
              )}
              ...
              <div className={`${styles.section__attachments__block}`}>
                {!!createTenderState.attachments.length && (
                  <div className={`${styles.section__attachments__block__cardList}`}>
                    {createTenderState.attachments.map((img, ind) => (
                      <div
                        key={img.id}
                        className={`${styles.section__attachments__block__cardItem}`}
                      >
                        {img.fileType === 'image' && windowWidth > 1050 ? (
                          <img
                            className={`${styles.section__attachments__block__cardItem__img}`}
                            src={
                              ind < createTenderState.attachments.length ? img.linkToSend : plusImg
                            }
                            alt=""
                          />
                        ) : (
                          <div
                            className={`${styles.section__attachments__block__cardItem__img} ${styles.section__attachments__block__cardItem__notImage}`}
                          >
                            <img
                              className={
                                styles.section__attachments__block__cardItem__notImageInfo__img
                              }
                              src={img.fileType === 'image' ? imgMobileImg : fileImg}
                              alt=""
                            />
                            <div
                              className={styles.section__attachments__block__cardItem__notImageInfo}
                            >
                              <p>
                                {/* {img.fileType === 'text' ? 'XML' : 'PDF'} */}
                                <span
                                  className={
                                    styles.section__attachments__block__cardItem__notImageInfo__span
                                  }
                                >
                                  {img.fileName}
                                </span>
                              ...
                              {windowWidth <= 1050 && (
                                <img
                                  onClick={() => createTenderState.removeAttachment(img.id)}
                                  src={closeGrayImg}
                                  alt=""
                                />
                              )}
                        ...
                        {windowWidth > 1050 && (
                          <>
                            <p className={`${styles.section__attachments__block__cardItem__text}`}>
                              {img.fileName}
                            </p>
                            <div
                              className={`${styles.section__attachments__block__cardItem__changes}`}
                            >
                              <img
                                className={`${styles.section__attachments__block__cardItem__changes__img}`}
                                src={changeAttachmentImg}
                                alt=""
                              ...
                              />
                              <span
                                className={`${styles.section__attachments__block__cardItem__changes__span}`}
                              ></span>
                              <img
                                onClick={() => createTenderState.removeAttachment(img.id)}
                                className={`${styles.section__attachments__block__cardItem__changes__img}`}
                                src={removeAttachmentImg}
                                alt=""
                              />
                              <p
                                onClick={() => createTenderState.removeAttachment(img.id)}
                                className={`${styles.section__attachments__block__cardItem__changes__text}`}
                              >
                                Удалить
                              </p>
                            </div>
                ...
                <button
                  ...
                  disabled={createTenderState.attachments.length >= 8}
                  className={`${styles.section__block__button} ${styles.textRegular} ${
                    styles.section__attachments__block__button
                  } ${
                    createTenderState.errors.includes('attachments')
                      ? styles.section__block__buttonError
                      : ''
                  }`}
                >
                  <img src={plusImg} alt="plus" />
                  Добавить вложения (до 8 шт.)
                </button>
                <input
                  type="file"
                  multiple
                ...
                {createTenderState.errors.includes('attachments') && (
                  <p
                    className={`${styles.inputErrorText} ${styles.inputErrorTextFloorSspace} ${styles.attachmentsError}`}
                  >
                    Обязательно для заполнения
                  </p>
                )}
          ...
          <div className={`${styles.section} ${styles.sendButtons}`}>
            <div className={`${styles.section__block}`}>
              ...
              <div className={`${styles.section__sendButtons__block}`}>
                ...
                <button className={styles.section__sendButtons__block__templateButton}>
