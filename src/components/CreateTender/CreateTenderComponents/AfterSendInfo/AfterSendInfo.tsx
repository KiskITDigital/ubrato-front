...
const AfterSendInfo: FC<{
  isDraft: boolean;
  executorName: string | null;
  closeModal: () => void;
}> = ({ executorName, closeModal, isDraft }) => {
  return (
      ...
      <div className={styles.title}>
        <p className={styles.title__text}>
          {isDraft ? (
            ...
            <>
              После модерации тендер будет отправлен исполнителю{" "}
              <span className={styles.link}>{executorName}</span>
            </>
          ) : (
      ...
      <div className={styles.info}>
        ...
        <p className={styles.info__text}>
          {isDraft ? (
            ...
            <>
              Сейчас ваш тендер находится на модерации и сохранен в разделе мои тендеры, после ее
              прохождения тендер будет отправлен выбранному исполнителю. Также вы можете создать еще
              один тендер.
            </>
          ) : (
            <>
              Сейчас ваш тендер находится на модерации и сохранен в разделе мои тендеры, после ее
              прохождения вы можете{" "}
              <Link className={styles.link} to="/find-executor">
                найти исполнителя
              </Link>{" "}
              и отправить ему тендер. Также вы можете создать еще один тендер.
            </>
          )}
        </p>
      </div>
