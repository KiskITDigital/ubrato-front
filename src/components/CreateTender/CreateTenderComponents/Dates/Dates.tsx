...
//                 </div>
//                 <div ref={calendarRef1} className={`${styles.firstSections__div__main} ${styles.firstSections__div__mainWork} ${datesStyles.dateTimeContainer}`} onFocus={(event) => {
//                     const target = event.target
//                     if (target instanceof Node) {
...
//                     <DateRangePickerLocal state={calendar1} setState={(newVal: boolean) => { setCalendar1(newVal); spanRef.current?.focus() }} timeToChangeStart="reception_start" timeToChangeEnd="reception_end" />
...
//                 </div>
//                 <div className={`${styles.firstSections__div__main} ${styles.firstSections__div__mainWork}`} ref={calendarRef2} onFocus={() => setCalendar2(true)}>
//                     <p className={`${styles.firstSections__div__main__block__p}`}>Начало</p>
//                     <p className={`${styles.firstSections__div__main__block__p}`}>Окончание</p>
//                     <DateRangePickerLocal state={calendar2} setState={(newVal: boolean) => { setCalendar2(newVal); spanRef.current?.focus() }} timeToChangeStart="work_start" timeToChangeEnd="work_end" />
//                 </div>
//             </div>
//         </div>
//     );
