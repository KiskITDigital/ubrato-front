...
const WhatObjects: FC = () => {
    ...
    return (
        <div className={qstyles.container}>
            <p className={qstyles.startText}>Для удобства формирования заявки можно указать объект, которым управляет ваша компания. Сейчас в каталоге Ubrato есть 14 типов объектов:</p>
            ...
            <p className={qstyles.text}>На сайте зарегистрированы исполнители, работающие как локально — в одном городе или регионе, так и в нескольких регионах или по всей территории России. Укажите в заявке, где расположен ваш объект.</p>
