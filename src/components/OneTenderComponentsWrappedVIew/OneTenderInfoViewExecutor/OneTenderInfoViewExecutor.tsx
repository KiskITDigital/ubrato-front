...
const dataTender = dataQ
  ...
  return (
    <div>
        <OneTenderInfoExecutor price={dataTender.price} timestamp_rc_start={dataTender.reception_start} timestamp_rc_end={dataTender.reception_end} timestamp_wrk_start={dataTender.work_start} timestamp_wrk_end={dataTender.work_end} timestamp_crtd={dataTender.created_at}></OneTenderInfoExecutor>
