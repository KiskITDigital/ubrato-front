      ...
      <div className={s.main_content}>
        ...
        <div className={s.content_block}>
          ...
          <p className={s.block_paragraph}>
            ...
            компании. Страница для загрузки документов доступна по этой <Link className={s.block_link} to={'/profile/documents'}> ссылке</Link>
            (ссылка на https://ubrato.ru/verification). После проверки
            достоверности документов администрацией Ubrato, пользователь
