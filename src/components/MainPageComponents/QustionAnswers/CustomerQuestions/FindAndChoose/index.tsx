    ...
    <div className={qstyles.container}>
      ...
      <ul className={qstyles.mb20}>
        <li className={qstyles.li}>
          ...
          и создайте заявку на тендер;
        </li>
        <li className={qstyles.li}>
          Отправьте заявку на модерацию и дождитесь публикации тендера;
        </li>
        <li className={qstyles.li}>
          После завершения приема откликов найдите нужный тендер в разделе
          <Link className={qstyles.link} to="/profile/tenders">
            «Мои тендеры»
          </Link>
          ;
        </li>
        <li className={qstyles.li}>
          В карточке тендера перейдите во вкладку «Отклики» и сравните отклики по величине
          стоимости;
        </li>
      ...
      <ul>
        ...
        <li className={qstyles.li}>
          На странице{' '}
          <Link className={qstyles.link} to="/find-executor">
            «Найти исполнителя»
          </Link>{' '}
          отфильтруйте исполнителей по вашим требованиям, например, тип объекта или вид услуги;
        </li>
