  ...
  return (
    <div className={`${qstyles.container}`}>
      <ul className={`${qstyles.mb20} ${qstyles.mt20}`}>
        ...
        <li className={qstyles.li}>
          Подготовьте необходимую информацию об объекте, датах и времени, когда
          вашей компании нужна услуга, сформулируйте критерии, по которым будете
          принимать работу. От полноты и точности этой информации будет зависеть
        ...
        <li className={qstyles.li}>
          Создайте заявку на тендер: укажите даты, когда нужен клининг, название
          населенного пункта и объект, где нужен клининг, описание необходимых
          услуг, стоимость (ваш бюджет) и другие параметры. По этим данным ваш
          тендер будут искать исполнители;
        </li>
        <li className={qstyles.li}>
          При необходимости сохраните заявку в статусе «Черновика»;
        </li>
        <li className={qstyles.li}>
          Отправьте заявку на модерацию. Она будет рассмотрена и опубликована в
          течение суток с момента отправки. Если у администрации сайта будут
          уточняющие вопросы по тендеру, мы свяжемся с вами;
        </li>
        <li className={qstyles.li}>
